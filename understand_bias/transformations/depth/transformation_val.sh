#!/bin/bash
#SBATCH --job-name=depth_train  # Job name
...
torchrun --nproc_per_node=$NUM_GPUS_TO_USE transform.py --dataset BAGEL --split val

torchrun --nproc_per_node=$NUM_GPUS_TO_USE transform.py --dataset Emu --split val

torchrun --nproc_per_node=$NUM_GPUS_TO_USE transform.py --dataset Janus --split val

torchrun --nproc_per_node=$NUM_GPUS_TO_USE transform.py --dataset MMaDA --split val

torchrun --nproc_per_node=$NUM_GPUS_TO_USE transform.py --dataset show --split val
