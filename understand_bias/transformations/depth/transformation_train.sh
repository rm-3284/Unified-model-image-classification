...
torchrun --nproc_per_node=$NUM_GPUS_TO_USE transform.py --dataset BAGEL --split train

torchrun --nproc_per_node=$NUM_GPUS_TO_USE transform.py --dataset Emu --split train
