...
@register_model
def convnext_atto_1_10_uniform(pretrained=False,in_22k=False, **kwargs):
    model = ConvNeXt(depths=[1, 1, 1, 1], dims=[10, 10, 10, 10],**kwargs)
    return model

@register_model
def convnext_atto_1_10(pretrained=False,in_22k=False, **kwargs):
    model = ConvNeXt(depths=[1, 1, 3, 1], dims=[10, 20, 40, 80],**kwargs)
    return model

@register_model
def convnext_atto_1_20(pretrained=False,in_22k=False, **kwargs):
    model = ConvNeXt(depths=[1, 1, 3, 1], dims=[20, 40, 80, 160],**kwargs)
    return model

@register_model
def convnext_atto_2_20(pretrained=False,in_22k=False, **kwargs):
    model = ConvNeXt(depths=[2, 2, 6, 2], dims=[20, 40, 80, 160],**kwargs)
    return model
